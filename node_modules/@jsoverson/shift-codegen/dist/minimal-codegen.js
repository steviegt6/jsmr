...
class MinimalCodeGen {
  ...
  reduceAssignmentExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(leftCode, t('='), rightCode), {
      containsIn,
      startsWithCurly,
  ...
  reduceCompoundAssignmentExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(leftCode, t(node.operator), rightCode), {
      containsIn,
      startsWithCurly,
      startsWithLetSquareBracket,
      startsWithFunctionOrClass
  ...
  reduceCallExpression(node, {
    ...
    const parenthizedArgs = args.map((a, i) => p(node.arguments[i], _coderep.Precedence.Assignment, a));
    return (0, _objectAssign.default)(seq(p(node.callee, (0, _coderep.getPrecedence)(node), callee), paren(commaSep(parenthizedArgs))), {
  ...
  reduceComputedMemberAssignmentTarget(node, {
    ...
    return (0, _objectAssign.default)(seq(p(node.object, (0, _coderep.getPrecedence)(node), object), bracket(expression)), {
  ...
  reduceConditionalExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(p(node.test, _coderep.Precedence.LogicalOR, test), t('?'), p(node.consequent, _coderep.Precedence.Assignment, consequent), t(':'), p(node.alternate, _coderep.Precedence.Assignment, alternate)), {
      containsIn,
      startsWithCurly,
      startsWithLetSquareBracket,
      startsWithFunctionOrClass
  ...
  reduceForInStatement(node, {
    ...
    return (0, _objectAssign.default)(seq(t('for'), paren(seq(left.startsWithLet ? paren(left) : left, t('in'), right)), body), {
  ...
  reduceForOfStatement(node, {
    ...
    left = node.left.type === 'VariableDeclaration' ? noIn(markContainsIn(left)) : left;
    return (0, _objectAssign.default)(seq(t('for'), paren(seq(left.startsWithLet ? paren(left) : left, t('of'), p(node.right, _coderep.Precedence.Assignment, right))), body), {
      endsWithMissingElse: body.endsWithMissingElse
    });
  }
  ...
  reduceForStatement(node, {
    ...
    return (0, _objectAssign.default)(seq(t('for'), paren(seq(init ? noIn(markContainsIn(init)) : empty(), semi(), test || empty(), semi(), update || empty())), body), {
      endsWithMissingElse: body.endsWithMissingElse
    });
  }
  ...
  reduceForAwaitStatement(node, {
    ...
    left = node.left.type === 'VariableDeclaration' ? noIn(markContainsIn(left)) : left;
    return (0, _objectAssign.default)(seq(t('for'), t('await'), paren(seq(left.startsWithLet ? paren(left) : left, t('of'), p(node.right, _coderep.Precedence.Assignment, right))), body), {
      endsWithMissingElse: body.endsWithMissingElse
    });
  }
  ...
  reduceArrowExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(node.isAsync ? t('async') : empty(), params, t('=>'), p(node.body, _coderep.Precedence.Assignment, body)), {
      containsIn
    });
  }
  ...
  reduceIfStatement(node, {
    ...
    return (0, _objectAssign.default)(seq(t('if'), paren(test), consequent, alternate ? seq(t('else'), alternate) : empty()), {
  ...
  reduceLabeledStatement(node, {
    ...
    return (0, _objectAssign.default)(seq(t(node.label + ':'), body), {
      endsWithMissingElse: body.endsWithMissingElse
    });
  }
  ...
  reduceNewExpression(node, {
    ...
    const parenthizedArgs = args.map((a, i) => p(node.arguments[i], _coderep.Precedence.Assignment, a));
    let calleeRep = (0, _coderep.getPrecedence)(node.callee) === _coderep.Precedence.Call ? paren(callee) : p(node.callee, (0, _coderep.getPrecedence)(node), callee);
  ...
  reduceUpdateExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(p(node.operand, _coderep.Precedence.New, operand), t(node.operator)), {
  ...
  reduceStaticMemberAssignmentTarget(node, {
    ...
    const state = seq(p(node.object, (0, _coderep.getPrecedence)(node), object), t('.'), t(node.property));
  ...
  reduceTemplateExpression(node, {
    ...
    let state = node.tag == null ? empty() : p(node.tag, (0, _coderep.getPrecedence)(node), tag);
    state = seq(state, t('`'));
  ...
  reduceYieldExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(t('yield'), p(node.expression, (0, _coderep.getPrecedence)(node), expression)), {
  ...
  reduceYieldGeneratorExpression(node, {
    ...
    return (0, _objectAssign.default)(seq(t('yield'), t('*'), p(node.expression, (0, _coderep.getPrecedence)(node), expression)), {
      containsIn: expression.containsIn
    });
  }
  ...
  reduceVariableDeclarator(node, {
    ...
    return (0, _objectAssign.default)(init == null ? binding : seq(binding, t('='), init), {
      containsIn
    });
  }
  ...
  reduceWhileStatement(node, {
    ...
    return (0, _objectAssign.default)(seq(t('while'), paren(test), body), {
      endsWithMissingElse: body.endsWithMissingElse
    });
  }
  ...
  reduceWithStatement(node, {
    ...
    return (0, _objectAssign.default)(seq(t('with'), paren(object), body), {
      endsWithMissingElse: body.endsWithMissingElse
    });
  }
