...
function thunkify(reducer) {
  return {
    ...
    reduceForInStatement: function reduceForInStatement(node, _ref34) {
    ...
    reduceForOfStatement: function reduceForOfStatement(node, _ref35) {
    ...
    reduceForStatement: function reduceForStatement(node, _ref36) {
      var init = _ref36.init,
          test = _ref36.test,
          update = _ref36.update,
          body = _ref36.body;
    ...
    reduceFormalParameters: function reduceFormalParameters(node, _ref37) {
    ...
    reduceFunctionBody: function reduceFunctionBody(node, _ref38) {
      var directives = _ref38.directives,
          statements = _ref38.statements;
    ...
    reduceFunctionDeclaration: function reduceFunctionDeclaration(node, _ref39) {
    ...
    reduceFunctionExpression: function reduceFunctionExpression(node, _ref40) {
    ...
    reduceGetter: function reduceGetter(node, _ref41) {
    ...
    reduceIfStatement: function reduceIfStatement(node, _ref42) {
    ...
    reduceImport: function reduceImport(node, _ref43) {
    ...
    reduceImportNamespace: function reduceImportNamespace(node, _ref44) {
    ...
    reduceImportSpecifier: function reduceImportSpecifier(node, _ref45) {
      var binding = _ref45.binding;

      return reducer.reduceImportSpecifier(node, { binding: binding() });
    },
    reduceLabeledStatement: function reduceLabeledStatement(node, _ref46) {
    ...
    reduceMethod: function reduceMethod(node, _ref47) {
    ...
    reduceModule: function reduceModule(node, _ref48) {
      var directives = _ref48.directives,
          items = _ref48.items;
    ...
    reduceNewExpression: function reduceNewExpression(node, _ref49) {
      var callee = _ref49.callee,
          _arguments = _ref49.arguments;
    ...
    reduceObjectAssignmentTarget: function reduceObjectAssignmentTarget(node, _ref50) {
    ...
    reduceObjectBinding: function reduceObjectBinding(node, _ref51) {
    ...
    reduceObjectExpression: function reduceObjectExpression(node, _ref52) {
    ...
    reduceReturnStatement: function reduceReturnStatement(node, _ref53) {
      var expression = _ref53.expression;

      return reducer.reduceReturnStatement(node, { expression: expression == null ? null : expression() });
    },
    reduceScript: function reduceScript(node, _ref54) {
      var directives = _ref54.directives,
          statements = _ref54.statements;
    ...
    reduceSetter: function reduceSetter(node, _ref55) {
    ...
    reduceShorthandProperty: function reduceShorthandProperty(node, _ref56) {
      var name = _ref56.name;

      return reducer.reduceShorthandProperty(node, { name: name() });
    },
    reduceSpreadElement: function reduceSpreadElement(node, _ref57) {
      var expression = _ref57.expression;

      return reducer.reduceSpreadElement(node, { expression: expression() });
    },
    reduceStaticMemberAssignmentTarget: function reduceStaticMemberAssignmentTarget(node, _ref58) {
      var object = _ref58.object;

      return reducer.reduceStaticMemberAssignmentTarget(node, { object: object() });
    },
    reduceStaticMemberExpression: function reduceStaticMemberExpression(node, _ref59) {
    ...
    reduceSwitchCase: function reduceSwitchCase(node, _ref60) {
      var test = _ref60.test,
          consequent = _ref60.consequent;

      return reducer.reduceSwitchCase(node, { test: test(), consequent: consequent.map(function (n) {
          return n();
        }) });
    },
    reduceSwitchDefault: function reduceSwitchDefault(node, _ref61) {
    ...
    reduceSwitchStatement: function reduceSwitchStatement(node, _ref62) {
    ...
    reduceSwitchStatementWithDefault: function reduceSwitchStatementWithDefault(node, _ref63) {
      var discriminant = _ref63.discriminant,
          preDefaultCases = _ref63.preDefaultCases,
          defaultCase = _ref63.defaultCase,
          postDefaultCases = _ref63.postDefaultCases;
    ...
    reduceTemplateExpression: function reduceTemplateExpression(node, _ref64) {
      var tag = _ref64.tag,
          elements = _ref64.elements;
    ...
    reduceThrowStatement: function reduceThrowStatement(node, _ref65) {
      var expression = _ref65.expression;

      return reducer.reduceThrowStatement(node, { expression: expression() });
    },
    reduceTryCatchStatement: function reduceTryCatchStatement(node, _ref66) {
    ...
    reduceTryFinallyStatement: function reduceTryFinallyStatement(node, _ref67) {
      var body = _ref67.body,
          catchClause = _ref67.catchClause,
          finalizer = _ref67.finalizer;
    ...
    reduceUnaryExpression: function reduceUnaryExpression(node, _ref68) {
      var operand = _ref68.operand;

      return reducer.reduceUnaryExpression(node, { operand: operand() });
    },
    reduceUpdateExpression: function reduceUpdateExpression(node, _ref69) {
      var operand = _ref69.operand;

      return reducer.reduceUpdateExpression(node, { operand: operand() });
    },
    reduceVariableDeclaration: function reduceVariableDeclaration(node, _ref70) {
      var declarators = _ref70.declarators;

      return reducer.reduceVariableDeclaration(node, { declarators: declarators.map(function (n) {
          return n();
        }) });
    },
    reduceVariableDeclarationStatement: function reduceVariableDeclarationStatement(node, _ref71) {
      var declaration = _ref71.declaration;

      return reducer.reduceVariableDeclarationStatement(node, { declaration: declaration() });
    },
    reduceVariableDeclarator: function reduceVariableDeclarator(node, _ref72) {
      var binding = _ref72.binding,
          init = _ref72.init;

      return reducer.reduceVariableDeclarator(node, { binding: binding(), init: init == null ? null : init() });
    },
    reduceWhileStatement: function reduceWhileStatement(node, _ref73) {
      var test = _ref73.test,
          body = _ref73.body;

      return reducer.reduceWhileStatement(node, { test: test(), body: body() });
    },
    reduceWithStatement: function reduceWithStatement(node, _ref74) {
      var object = _ref74.object,
          body = _ref74.body;

      return reducer.reduceWithStatement(node, { object: object(), body: body() });
    },
    reduceYieldExpression: function reduceYieldExpression(node, _ref75) {
      var expression = _ref75.expression;

      return reducer.reduceYieldExpression(node, { expression: expression == null ? null : expression() });
    },
    reduceYieldGeneratorExpression: function reduceYieldGeneratorExpression(node, _ref76) {
