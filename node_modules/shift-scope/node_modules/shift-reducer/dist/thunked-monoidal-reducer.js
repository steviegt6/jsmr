...
var MonoidalReducer = function () {
  ...
  _createClass(MonoidalReducer, [{
    ...
    value: function reduceForInStatement(node, _ref34) {
    ...
    value: function reduceForOfStatement(node, _ref35) {
    ...
    value: function reduceForStatement(node, _ref36) {
      var _this7 = this;
    ...
    value: function reduceFunctionBody(node, _ref38) {
    ...
    value: function reduceFunctionDeclaration(node, _ref39) {
    ...
    value: function reduceFunctionExpression(node, _ref40) {
      var _this9 = this;
    ...
    value: function reduceLabeledStatement(node, _ref46) {
    ...
    key: 'reduceMethod',
    value: function reduceMethod(node, _ref47) {
    ...
    key: 'reduceModule',
    value: function reduceModule(node, _ref48) {
    ...
    value: function reduceNewExpression(node, _ref49) {
    ...
    value: function reduceObjectAssignmentTarget(node, _ref50) {
    ...
    value: function reduceObjectBinding(node, _ref51) {
    ...
    value: function reduceReturnStatement(node, _ref53) {
    ...
    key: 'reduceScript',
    value: function reduceScript(node, _ref54) {
    ...
    key: 'reduceSetter',
    value: function reduceSetter(node, _ref55) {
    ...
    value: function reduceShorthandProperty(node, _ref56) {
    ...
    value: function reduceSpreadElement(node, _ref57) {
    ...
    value: function reduceStaticMemberAssignmentTarget(node, _ref58) {
    ...
    value: function reduceStaticMemberExpression(node, _ref59) {
    ...
    value: function reduceSwitchCase(node, _ref60) {
    ...
    value: function reduceSwitchDefault(node, _ref61) {
    ...
    value: function reduceSwitchStatement(node, _ref62) {
    ...
    value: function reduceSwitchStatementWithDefault(node, _ref63) {
    ...
    value: function reduceTemplateExpression(node, _ref64) {
      var _this13 = this;
    ...
    value: function reduceThrowStatement(node, _ref65) {
    ...
    value: function reduceTryCatchStatement(node, _ref66) {
    ...
    value: function reduceTryFinallyStatement(node, _ref67) {
      var _this14 = this;
    ...
    value: function reduceUnaryExpression(node, _ref68) {
    ...
    value: function reduceUpdateExpression(node, _ref69) {
    ...
    value: function reduceVariableDeclaration(node, _ref70) {
    ...
    value: function reduceVariableDeclarationStatement(node, _ref71) {
    ...
    value: function reduceVariableDeclarator(node, _ref72) {
      var _this15 = this;
    ...
    value: function reduceWhileStatement(node, _ref73) {
    ...
    value: function reduceWithStatement(node, _ref74) {
    ...
    value: function reduceYieldExpression(node, _ref75) {
    ...
    value: function reduceYieldGeneratorExpression(node, _ref76) {
